...
|`00_OPERATING_MODEL.md`|Full operating model: scope details, roles glossary, deliverables, governance, completeness states, sign-off mechanics, team coordination, working group + beta feedback practices, current project state. The custom instructions hold the always-on principles; this file holds the detailed framework. **Read at session start.**|
